...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_split_3x6_3(
    ...
    LT(LINUX, U_NU), LT(BUTTON, KC_Z),  ALGR_T(KC_X),      KC_C,              KC_D,              KC_V,              KC_K,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    LT(BUTTON, KC_SLSH), KC_RALT,
  ...
  [LINUX] = LAYOUT_split_3x6_3(
    RGUI(KC_GRAVE),RGUI(KC_1),   RGUI(KC_2),   RGUI(KC_3),   RGUI(KC_4),   RGUI(KC_5),   RGUI(KC_6),   RGUI(KC_7),   RGUI(KC_8),   RGUI(KC_9),   U_NA, U_NA,
    U_NA, U_NA,      U_NA,      U_NA,      RGUI(KC_F),      U_NA,              RGUI(KC_H),              RGUI(KC_J),      RGUI(KC_K),      RGUI(KC_L),      RGUI(KC_SEMICOLON), U_NA,
    U_NA, U_NA,  U_NA,      U_NA,              U_NA,              U_NA,              U_NA,              U_NA,              U_NA,           U_NA,    U_NA, U_NA,
    U_NA, RGUI(KC_SPC), U_NA, RGUI(KC_ENT), U_NA, U_NA
  )
};
